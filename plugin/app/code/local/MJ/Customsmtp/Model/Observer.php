    ...
    public function sendTestMail($observer)
    {
        ...
        if (array_key_exists('test', self::$fields) && 4 == count(self::$fields)) {
            ...
            if ($connected) {
                ...
                throw new Exception(sPrintF('Please contact Mailjet support to sort this out.<br /><br />%d - %s',
                    $errno, $errstr));
            }
        }
    }
